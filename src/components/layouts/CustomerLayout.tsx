...
const CustomerLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Subscriptions', href: '/customer/subscriptions', icon: CreditCard },
        ...
        <div className="flex h-full flex-col overflow-y-auto border-r border-gray-200 bg-background">
          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="border-t border-gray-200 p-4">
              <NavLink
                to="/auth/login"
                className="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-beige hover:text-text"
              >
                <LogOut
              ...
              <div className="relative">
                ...
                >
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-beige">
                    <span className="text-xs font-medium leading-none text-text">JD</span>
                  </span>
                </button>
              </div>
            </div>
