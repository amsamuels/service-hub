        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <NavigationMenu.Root className="hidden lg:flex lg:gap-x-12">
            <NavigationMenu.List className="flex space-x-8">
              <NavigationMenu.Item>
                <NavigationMenu.Trigger className="text-sm font-semibold leading-6 text-text group">
                  Features
                  <ChevronDown className="h-4 w-4 ml-1 inline-block group-hover:rotate-180 transition-transform" />
